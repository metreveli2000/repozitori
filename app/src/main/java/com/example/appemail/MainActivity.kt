...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        inputPassword = findViewById(R.id.signInPasswordEditText2)
        loginButton = findViewById(R.id.signInButton)
        registerButton = findViewById(R.id.goToRegistrationButton2)
        resetButton = findViewById(R.id.goToPasswordResetButton3)
